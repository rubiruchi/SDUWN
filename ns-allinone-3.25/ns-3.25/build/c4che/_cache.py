...
CC = ['/usr/bin/gcc']
CCDEFINES = ['_DEBUG']
CCFLAGS = ['-O0', '-ggdb', '-g3', '-Wall', '-Werror', '-std=c++0x', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
...
EXAMPLE_DIRECTORIES = ['traffic-control', 'tcp', 'stats', 'socket', 'udp-client-server', 'routing', 'error-model', 'naming', 'realtime', 'udp', 'energy', 'wireless', 'matrix-topology', 'ipv6', 'tutorial']
...
NS3_EXECUTABLE_PATH = ['/home/yuxin/Workspace-NS3.25+Mininet/ns-allinone-3.25/ns-3.25/build/src/fd-net-device', '/home/yuxin/Workspace-NS3.25+Mininet/ns-allinone-3.25/ns-3.25/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/5', '/home/yuxin/Workspace-NS3.25+Mininet/ns-allinone-3.25/ns-3.25/build']
...
VALGRIND_FOUND = True
VERSION = '3.25'
WITH_PYBINDGEN = '/home/yuxin/Workspace-NS3.25+Mininet/ns-allinone-3.25/pybindgen-0.17.0.post49+ng0e4e3bc'
WL_SONAME_SUPPORTED = True
cfg_files = ['/home/yuxin/Workspace-NS3.25+Mininet/ns-allinone-3.25/ns-3.25/build/ns3/config-store-config.h', '/home/yuxin/Workspace-NS3.25+Mininet/ns-allinone-3.25/ns-3.25/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
