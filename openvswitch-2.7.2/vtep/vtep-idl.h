...
void vteprec_acl_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_acl_update_acl_fault_status_addvalue(const struct vteprec_acl *,  const char *);
...
void vteprec_acl_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_acl_add_clause_acl_name(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *acl_name);
...
void vteprec_acl_entry_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_acl_entry_add_clause_action(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *action);
void vteprec_acl_entry_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_acl_entry_update_dest_ip_addvalue(const struct vteprec_acl_entry *,  const char *);
...
void vteprec_acl_entry_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_acl_entry_update_dest_mac_addvalue(const struct vteprec_acl_entry *,  const char *);
...
void vteprec_acl_entry_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_acl_entry_update_dest_mask_addvalue(const struct vteprec_acl_entry *,  const char *);
...
void vteprec_acl_entry_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_acl_entry_update_dest_port_max_addvalue(const struct vteprec_acl_entry *,  int64_t );
...
void vteprec_acl_entry_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_acl_entry_update_dest_port_min_addvalue(const struct vteprec_acl_entry *,  int64_t );
...
void vteprec_acl_entry_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_acl_entry_add_clause_direction(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *direction);
void vteprec_acl_entry_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_acl_entry_update_ethertype_addvalue(const struct vteprec_acl_entry *,  const char *);
...
void vteprec_acl_entry_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_acl_entry_update_icmp_code_addvalue(const struct vteprec_acl_entry *,  int64_t );
...
void vteprec_acl_entry_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_acl_entry_update_icmp_type_addvalue(const struct vteprec_acl_entry *,  int64_t );
...
void vteprec_acl_entry_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_acl_entry_update_protocol_addvalue(const struct vteprec_acl_entry *,  int64_t );
...
void vteprec_acl_entry_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_acl_entry_add_clause_sequence(struct ovsdb_idl_condition *, enum ovsdb_function function, int64_t sequence);
void vteprec_acl_entry_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_acl_entry_update_source_ip_addvalue(const struct vteprec_acl_entry *,  const char *);
...
void vteprec_acl_entry_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_acl_entry_update_source_mac_addvalue(const struct vteprec_acl_entry *,  const char *);
...
void vteprec_acl_entry_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_acl_entry_update_source_mask_addvalue(const struct vteprec_acl_entry *,  const char *);
...
void vteprec_acl_entry_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_acl_entry_update_source_port_max_addvalue(const struct vteprec_acl_entry *,  int64_t );
...
void vteprec_acl_entry_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_acl_entry_update_source_port_min_addvalue(const struct vteprec_acl_entry *,  int64_t );
...
void vteprec_acl_entry_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_acl_entry_update_tcp_flags_addvalue(const struct vteprec_acl_entry *,  int64_t );
...
void vteprec_acl_entry_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_acl_entry_update_tcp_flags_mask_addvalue(const struct vteprec_acl_entry *,  int64_t );
...
void vteprec_arp_sources_local_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_arp_sources_local_add_clause_src_mac(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *src_mac);
...
void vteprec_arp_sources_remote_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_arp_sources_remote_add_clause_src_mac(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *src_mac);
...
void vteprec_global_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_global_update_other_config_setkey(const struct vteprec_global *,  const char *, const char *);
...
void vteprec_global_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_global_update_switches_addvalue(const struct vteprec_global *,  const struct vteprec_physical_switch *);
...
void vteprec_logical_binding_stats_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_logical_binding_stats_add_clause_bytes_to_local(struct ovsdb_idl_condition *, enum ovsdb_function function, int64_t bytes_to_local);
void vteprec_logical_binding_stats_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_logical_binding_stats_add_clause_packets_from_local(struct ovsdb_idl_condition *, enum ovsdb_function function, int64_t packets_from_local);
void vteprec_logical_binding_stats_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_logical_binding_stats_add_clause_packets_to_local(struct ovsdb_idl_condition *, enum ovsdb_function function, int64_t packets_to_local);
...
void vteprec_logical_router_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_logical_router_update_acl_binding_setkey(const struct vteprec_logical_router *,  const char *, const struct vteprec_acl *);
...
void vteprec_logical_router_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_logical_router_add_clause_description(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *description);
void vteprec_logical_router_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_logical_router_add_clause_name(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *name);
void vteprec_logical_router_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_logical_router_update_other_config_setkey(const struct vteprec_logical_router *,  const char *, const char *);
...
void vteprec_logical_router_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_logical_router_update_static_routes_setkey(const struct vteprec_logical_router *,  const char *, const char *);
...
void vteprec_logical_router_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_logical_router_update_switch_binding_setkey(const struct vteprec_logical_router *,  const char *, const struct vteprec_logical_switch *);
...
void vteprec_logical_switch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_logical_switch_add_clause_name(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *name);
void vteprec_logical_switch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_logical_switch_update_other_config_setkey(const struct vteprec_logical_switch *,  const char *, const char *);
...
void vteprec_logical_switch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_logical_switch_update_replication_mode_addvalue(const struct vteprec_logical_switch *,  const char *);
...
void vteprec_logical_switch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_logical_switch_update_tunnel_key_addvalue(const struct vteprec_logical_switch *,  int64_t );
...
void vteprec_manager_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_manager_add_clause_is_connected(struct ovsdb_idl_condition *, enum ovsdb_function function, bool is_connected);
void vteprec_manager_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_manager_update_max_backoff_addvalue(const struct vteprec_manager *,  int64_t );
...
void vteprec_manager_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_manager_update_other_config_setkey(const struct vteprec_manager *,  const char *, const char *);
...
void vteprec_manager_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_manager_update_status_setkey(const struct vteprec_manager *,  const char *, const char *);
...
void vteprec_manager_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_manager_add_clause_target(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *target);
...
void vteprec_mcast_macs_local_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_mcast_macs_local_add_clause_ipaddr(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *ipaddr);
void vteprec_mcast_macs_local_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_mcast_macs_local_add_clause_locator_set(struct ovsdb_idl_condition *, enum ovsdb_function function, const struct uuid *locator_set);
void vteprec_mcast_macs_local_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_mcast_macs_local_add_clause_logical_switch(struct ovsdb_idl_condition *, enum ovsdb_function function, const struct uuid *logical_switch);
...
void vteprec_mcast_macs_remote_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_mcast_macs_remote_add_clause_ipaddr(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *ipaddr);
void vteprec_mcast_macs_remote_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_mcast_macs_remote_add_clause_locator_set(struct ovsdb_idl_condition *, enum ovsdb_function function, const struct uuid *locator_set);
void vteprec_mcast_macs_remote_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_mcast_macs_remote_add_clause_logical_switch(struct ovsdb_idl_condition *, enum ovsdb_function function, const struct uuid *logical_switch);
...
void vteprec_physical_locator_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_physical_locator_add_clause_encapsulation_type(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *encapsulation_type);
void vteprec_physical_locator_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_physical_locator_update_tunnel_key_addvalue(const struct vteprec_physical_locator *,  int64_t );
...
void vteprec_physical_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_physical_port_add_clause_description(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *description);
void vteprec_physical_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_physical_port_add_clause_name(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *name);
void vteprec_physical_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_physical_port_update_other_config_setkey(const struct vteprec_physical_port *,  const char *, const char *);
...
void vteprec_physical_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_physical_port_update_port_fault_status_addvalue(const struct vteprec_physical_port *,  const char *);
...
void vteprec_physical_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_physical_port_update_vlan_bindings_setkey(const struct vteprec_physical_port *,  int64_t , const struct vteprec_logical_switch *);
...
void vteprec_physical_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_physical_port_update_vlan_stats_setkey(const struct vteprec_physical_port *,  int64_t , const struct vteprec_logical_binding_stats *);
...
void vteprec_physical_switch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_physical_switch_update_management_ips_addvalue(const struct vteprec_physical_switch *,  const char *);
...
void vteprec_physical_switch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_physical_switch_add_clause_name(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *name);
void vteprec_physical_switch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_physical_switch_update_other_config_setkey(const struct vteprec_physical_switch *,  const char *, const char *);
...
void vteprec_physical_switch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_physical_switch_update_ports_addvalue(const struct vteprec_physical_switch *,  const struct vteprec_physical_port *);
...
void vteprec_physical_switch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_physical_switch_update_switch_fault_status_addvalue(const struct vteprec_physical_switch *,  const char *);
...
void vteprec_physical_switch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_physical_switch_update_tunnel_ips_addvalue(const struct vteprec_physical_switch *,  const char *);
...
void vteprec_physical_switch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_physical_switch_update_tunnels_addvalue(const struct vteprec_physical_switch *,  const struct vteprec_tunnel *);
...
void vteprec_tunnel_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_tunnel_update_bfd_config_remote_setkey(const struct vteprec_tunnel *,  const char *, const char *);
...
void vteprec_tunnel_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_tunnel_update_bfd_params_setkey(const struct vteprec_tunnel *,  const char *, const char *);
...
void vteprec_tunnel_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_tunnel_update_bfd_status_setkey(const struct vteprec_tunnel *,  const char *, const char *);
...
void vteprec_tunnel_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_tunnel_add_clause_local(struct ovsdb_idl_condition *, enum ovsdb_function function, const struct uuid *local);
void vteprec_tunnel_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_tunnel_add_clause_remote(struct ovsdb_idl_condition *, enum ovsdb_function function, const struct uuid *remote);
...
void vteprec_ucast_macs_local_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_ucast_macs_local_add_clause_ipaddr(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *ipaddr);
void vteprec_ucast_macs_local_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_ucast_macs_local_add_clause_locator(struct ovsdb_idl_condition *, enum ovsdb_function function, const struct uuid *locator);
void vteprec_ucast_macs_local_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_ucast_macs_local_add_clause_logical_switch(struct ovsdb_idl_condition *, enum ovsdb_function function, const struct uuid *logical_switch);
...
void vteprec_ucast_macs_remote_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_ucast_macs_remote_add_clause_ipaddr(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *ipaddr);
void vteprec_ucast_macs_remote_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_ucast_macs_remote_add_clause_locator(struct ovsdb_idl_condition *, enum ovsdb_function function, const struct uuid *locator);
void vteprec_ucast_macs_remote_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void vteprec_ucast_macs_remote_add_clause_logical_switch(struct ovsdb_idl_condition *, enum ovsdb_function function, const struct uuid *logical_switch);
