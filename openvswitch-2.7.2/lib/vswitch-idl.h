...
void ovsrec_autoattach_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_autoattach_add_clause_system_description(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *system_description);
void ovsrec_autoattach_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_autoattach_add_clause_system_name(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *system_name);
...
void ovsrec_bridge_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_bridge_update_controller_addvalue(const struct ovsrec_bridge *,  const struct ovsrec_controller *);
...
void ovsrec_bridge_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_bridge_update_datapath_id_addvalue(const struct ovsrec_bridge *,  const char *);
...
void ovsrec_bridge_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_bridge_add_clause_datapath_type(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *datapath_type);
void ovsrec_bridge_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_bridge_add_clause_datapath_version(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *datapath_version);
void ovsrec_bridge_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_bridge_update_external_ids_setkey(const struct ovsrec_bridge *,  const char *, const char *);
...
void ovsrec_bridge_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_bridge_update_fail_mode_addvalue(const struct ovsrec_bridge *,  const char *);
...
void ovsrec_bridge_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_bridge_update_flood_vlans_addvalue(const struct ovsrec_bridge *,  int64_t );
...
void ovsrec_bridge_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_bridge_update_flow_tables_setkey(const struct ovsrec_bridge *,  int64_t , const struct ovsrec_flow_table *);
...
void ovsrec_bridge_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_bridge_update_ipfix_addvalue(const struct ovsrec_bridge *,  const struct ovsrec_ipfix *);
...
void ovsrec_bridge_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_bridge_add_clause_mcast_snooping_enable(struct ovsdb_idl_condition *, enum ovsdb_function function, bool mcast_snooping_enable);
void ovsrec_bridge_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_bridge_update_mirrors_addvalue(const struct ovsrec_bridge *,  const struct ovsrec_mirror *);
...
void ovsrec_bridge_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_bridge_add_clause_name(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *name);
void ovsrec_bridge_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_bridge_update_netflow_addvalue(const struct ovsrec_bridge *,  const struct ovsrec_netflow *);
...
void ovsrec_bridge_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_bridge_update_other_config_setkey(const struct ovsrec_bridge *,  const char *, const char *);
...
void ovsrec_bridge_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_bridge_update_ports_addvalue(const struct ovsrec_bridge *,  const struct ovsrec_port *);
...
void ovsrec_bridge_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_bridge_update_protocols_addvalue(const struct ovsrec_bridge *,  const char *);
...
void ovsrec_bridge_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_bridge_add_clause_rstp_enable(struct ovsdb_idl_condition *, enum ovsdb_function function, bool rstp_enable);
void ovsrec_bridge_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_bridge_update_rstp_status_setkey(const struct ovsrec_bridge *,  const char *, const char *);
...
void ovsrec_bridge_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_bridge_update_sflow_addvalue(const struct ovsrec_bridge *,  const struct ovsrec_sflow *);
...
void ovsrec_bridge_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_bridge_update_status_setkey(const struct ovsrec_bridge *,  const char *, const char *);
...
void ovsrec_bridge_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_bridge_add_clause_stp_enable(struct ovsdb_idl_condition *, enum ovsdb_function function, bool stp_enable);
...
void ovsrec_controller_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_controller_update_controller_burst_limit_addvalue(const struct ovsrec_controller *,  int64_t );
...
void ovsrec_controller_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_controller_update_controller_rate_limit_addvalue(const struct ovsrec_controller *,  int64_t );
...
void ovsrec_controller_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_controller_update_enable_async_messages_addvalue(const struct ovsrec_controller *,  bool );
...
void ovsrec_controller_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_controller_update_external_ids_setkey(const struct ovsrec_controller *,  const char *, const char *);
...
void ovsrec_controller_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_controller_update_inactivity_probe_addvalue(const struct ovsrec_controller *,  int64_t );
...
void ovsrec_controller_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_controller_add_clause_is_connected(struct ovsdb_idl_condition *, enum ovsdb_function function, bool is_connected);
void ovsrec_controller_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_controller_update_local_gateway_addvalue(const struct ovsrec_controller *,  const char *);
...
void ovsrec_controller_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_controller_update_local_ip_addvalue(const struct ovsrec_controller *,  const char *);
...
void ovsrec_controller_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_controller_update_local_netmask_addvalue(const struct ovsrec_controller *,  const char *);
...
void ovsrec_controller_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_controller_update_max_backoff_addvalue(const struct ovsrec_controller *,  int64_t );
...
void ovsrec_controller_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_controller_update_other_config_setkey(const struct ovsrec_controller *,  const char *, const char *);
...
void ovsrec_controller_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_controller_update_role_addvalue(const struct ovsrec_controller *,  const char *);
...
void ovsrec_controller_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_controller_update_status_setkey(const struct ovsrec_controller *,  const char *, const char *);
...
void ovsrec_controller_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_controller_add_clause_target(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *target);
...
void ovsrec_flow_sample_collector_set_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_flow_sample_collector_set_update_external_ids_setkey(const struct ovsrec_flow_sample_collector_set *,  const char *, const char *);
...
void ovsrec_flow_sample_collector_set_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_flow_sample_collector_set_add_clause_id(struct ovsdb_idl_condition *, enum ovsdb_function function, int64_t id);
void ovsrec_flow_sample_collector_set_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_flow_sample_collector_set_update_ipfix_addvalue(const struct ovsrec_flow_sample_collector_set *,  const struct ovsrec_ipfix *);
...
void ovsrec_flow_table_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_flow_table_update_flow_limit_addvalue(const struct ovsrec_flow_table *,  int64_t );
...
void ovsrec_flow_table_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_flow_table_update_groups_addvalue(const struct ovsrec_flow_table *,  const char *);
...
void ovsrec_flow_table_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_flow_table_update_name_addvalue(const struct ovsrec_flow_table *,  const char *);
...
void ovsrec_flow_table_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_flow_table_update_overflow_policy_addvalue(const struct ovsrec_flow_table *,  const char *);
...
void ovsrec_flow_table_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_flow_table_update_prefixes_addvalue(const struct ovsrec_flow_table *,  const char *);
...
void ovsrec_ipfix_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_ipfix_update_cache_max_flows_addvalue(const struct ovsrec_ipfix *,  int64_t );
...
void ovsrec_ipfix_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_ipfix_update_external_ids_setkey(const struct ovsrec_ipfix *,  const char *, const char *);
...
void ovsrec_ipfix_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_ipfix_update_obs_domain_id_addvalue(const struct ovsrec_ipfix *,  int64_t );
...
void ovsrec_ipfix_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_ipfix_update_obs_point_id_addvalue(const struct ovsrec_ipfix *,  int64_t );
...
void ovsrec_ipfix_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_ipfix_update_other_config_setkey(const struct ovsrec_ipfix *,  const char *, const char *);
...
void ovsrec_ipfix_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_ipfix_update_sampling_addvalue(const struct ovsrec_ipfix *,  int64_t );
...
void ovsrec_ipfix_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_ipfix_update_targets_addvalue(const struct ovsrec_ipfix *,  const char *);
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_bfd_setkey(const struct ovsrec_interface *,  const char *, const char *);
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_bfd_status_setkey(const struct ovsrec_interface *,  const char *, const char *);
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_cfm_fault_addvalue(const struct ovsrec_interface *,  bool );
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_cfm_fault_status_addvalue(const struct ovsrec_interface *,  const char *);
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_cfm_flap_count_addvalue(const struct ovsrec_interface *,  int64_t );
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_cfm_health_addvalue(const struct ovsrec_interface *,  int64_t );
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_cfm_mpid_addvalue(const struct ovsrec_interface *,  int64_t );
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_cfm_remote_mpids_addvalue(const struct ovsrec_interface *,  int64_t );
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_cfm_remote_opstate_addvalue(const struct ovsrec_interface *,  const char *);
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_duplex_addvalue(const struct ovsrec_interface *,  const char *);
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_error_addvalue(const struct ovsrec_interface *,  const char *);
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_external_ids_setkey(const struct ovsrec_interface *,  const char *, const char *);
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_ifindex_addvalue(const struct ovsrec_interface *,  int64_t );
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_add_clause_ingress_policing_burst(struct ovsdb_idl_condition *, enum ovsdb_function function, int64_t ingress_policing_burst);
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_add_clause_ingress_policing_rate(struct ovsdb_idl_condition *, enum ovsdb_function function, int64_t ingress_policing_rate);
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_lacp_current_addvalue(const struct ovsrec_interface *,  bool );
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_link_resets_addvalue(const struct ovsrec_interface *,  int64_t );
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_link_speed_addvalue(const struct ovsrec_interface *,  int64_t );
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_link_state_addvalue(const struct ovsrec_interface *,  const char *);
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_lldp_setkey(const struct ovsrec_interface *,  const char *, const char *);
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_mac_addvalue(const struct ovsrec_interface *,  const char *);
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_mac_in_use_addvalue(const struct ovsrec_interface *,  const char *);
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_mtu_addvalue(const struct ovsrec_interface *,  int64_t );
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_mtu_request_addvalue(const struct ovsrec_interface *,  int64_t );
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_add_clause_name(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *name);
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_ofport_addvalue(const struct ovsrec_interface *,  int64_t );
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_ofport_request_addvalue(const struct ovsrec_interface *,  int64_t );
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_options_setkey(const struct ovsrec_interface *,  const char *, const char *);
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_other_config_setkey(const struct ovsrec_interface *,  const char *, const char *);
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_statistics_setkey(const struct ovsrec_interface *,  const char *, int64_t );
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_update_status_setkey(const struct ovsrec_interface *,  const char *, const char *);
...
void ovsrec_interface_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_interface_add_clause_type(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *type);
...
void ovsrec_manager_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_manager_update_external_ids_setkey(const struct ovsrec_manager *,  const char *, const char *);
...
void ovsrec_manager_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_manager_update_inactivity_probe_addvalue(const struct ovsrec_manager *,  int64_t );
...
void ovsrec_manager_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_manager_add_clause_is_connected(struct ovsdb_idl_condition *, enum ovsdb_function function, bool is_connected);
void ovsrec_manager_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_manager_update_max_backoff_addvalue(const struct ovsrec_manager *,  int64_t );
...
void ovsrec_manager_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_manager_update_other_config_setkey(const struct ovsrec_manager *,  const char *, const char *);
...
void ovsrec_manager_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_manager_update_status_setkey(const struct ovsrec_manager *,  const char *, const char *);
...
void ovsrec_manager_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_manager_add_clause_target(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *target);
...
void ovsrec_mirror_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_mirror_add_clause_name(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *name);
void ovsrec_mirror_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_mirror_update_output_port_addvalue(const struct ovsrec_mirror *,  const struct ovsrec_port *);
...
void ovsrec_mirror_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_mirror_update_output_vlan_addvalue(const struct ovsrec_mirror *,  int64_t );
...
void ovsrec_mirror_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_mirror_add_clause_select_all(struct ovsdb_idl_condition *, enum ovsdb_function function, bool select_all);
void ovsrec_mirror_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_mirror_update_select_dst_port_addvalue(const struct ovsrec_mirror *,  const struct ovsrec_port *);
...
void ovsrec_mirror_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_mirror_update_select_src_port_addvalue(const struct ovsrec_mirror *,  const struct ovsrec_port *);
...
void ovsrec_mirror_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_mirror_update_select_vlan_addvalue(const struct ovsrec_mirror *,  int64_t );
...
void ovsrec_mirror_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_mirror_update_snaplen_addvalue(const struct ovsrec_mirror *,  int64_t );
...
void ovsrec_mirror_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_mirror_update_statistics_setkey(const struct ovsrec_mirror *,  const char *, int64_t );
...
void ovsrec_netflow_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_netflow_add_clause_add_id_to_interface(struct ovsdb_idl_condition *, enum ovsdb_function function, bool add_id_to_interface);
void ovsrec_netflow_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_netflow_update_engine_id_addvalue(const struct ovsrec_netflow *,  int64_t );
...
void ovsrec_netflow_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_netflow_update_engine_type_addvalue(const struct ovsrec_netflow *,  int64_t );
...
void ovsrec_netflow_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_netflow_update_external_ids_setkey(const struct ovsrec_netflow *,  const char *, const char *);
...
void ovsrec_netflow_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_netflow_update_targets_addvalue(const struct ovsrec_netflow *,  const char *);
...
void ovsrec_open_vswitch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_open_vswitch_add_clause_cur_cfg(struct ovsdb_idl_condition *, enum ovsdb_function function, int64_t cur_cfg);
void ovsrec_open_vswitch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_open_vswitch_update_datapath_types_addvalue(const struct ovsrec_open_vswitch *,  const char *);
...
void ovsrec_open_vswitch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_open_vswitch_update_db_version_addvalue(const struct ovsrec_open_vswitch *,  const char *);
...
void ovsrec_open_vswitch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_open_vswitch_update_external_ids_setkey(const struct ovsrec_open_vswitch *,  const char *, const char *);
...
void ovsrec_open_vswitch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_open_vswitch_update_iface_types_addvalue(const struct ovsrec_open_vswitch *,  const char *);
...
void ovsrec_open_vswitch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_open_vswitch_update_manager_options_addvalue(const struct ovsrec_open_vswitch *,  const struct ovsrec_manager *);
...
void ovsrec_open_vswitch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_open_vswitch_add_clause_next_cfg(struct ovsdb_idl_condition *, enum ovsdb_function function, int64_t next_cfg);
void ovsrec_open_vswitch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_open_vswitch_update_other_config_setkey(const struct ovsrec_open_vswitch *,  const char *, const char *);
...
void ovsrec_open_vswitch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_open_vswitch_update_ovs_version_addvalue(const struct ovsrec_open_vswitch *,  const char *);
...
void ovsrec_open_vswitch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_open_vswitch_update_ssl_addvalue(const struct ovsrec_open_vswitch *,  const struct ovsrec_ssl *);
...
void ovsrec_open_vswitch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_open_vswitch_update_statistics_setkey(const struct ovsrec_open_vswitch *,  const char *, const char *);
...
void ovsrec_open_vswitch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_open_vswitch_update_system_type_addvalue(const struct ovsrec_open_vswitch *,  const char *);
...
void ovsrec_open_vswitch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_open_vswitch_update_system_version_addvalue(const struct ovsrec_open_vswitch *,  const char *);
...
void ovsrec_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_port_add_clause_bond_downdelay(struct ovsdb_idl_condition *, enum ovsdb_function function, int64_t bond_downdelay);
void ovsrec_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_port_add_clause_bond_fake_iface(struct ovsdb_idl_condition *, enum ovsdb_function function, bool bond_fake_iface);
void ovsrec_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_port_update_bond_mode_addvalue(const struct ovsrec_port *,  const char *);
...
void ovsrec_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_port_add_clause_bond_updelay(struct ovsdb_idl_condition *, enum ovsdb_function function, int64_t bond_updelay);
void ovsrec_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_port_update_external_ids_setkey(const struct ovsrec_port *,  const char *, const char *);
...
void ovsrec_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_port_add_clause_fake_bridge(struct ovsdb_idl_condition *, enum ovsdb_function function, bool fake_bridge);
void ovsrec_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_port_update_interfaces_addvalue(const struct ovsrec_port *,  const struct ovsrec_interface *);
...
void ovsrec_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_port_update_lacp_addvalue(const struct ovsrec_port *,  const char *);
...
void ovsrec_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_port_update_mac_addvalue(const struct ovsrec_port *,  const char *);
...
void ovsrec_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_port_add_clause_name(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *name);
void ovsrec_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_port_update_other_config_setkey(const struct ovsrec_port *,  const char *, const char *);
...
void ovsrec_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_port_add_clause_protected(struct ovsdb_idl_condition *, enum ovsdb_function function, bool protected);
void ovsrec_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_port_update_qos_addvalue(const struct ovsrec_port *,  const struct ovsrec_qos *);
...
void ovsrec_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_port_update_rstp_statistics_setkey(const struct ovsrec_port *,  const char *, int64_t );
...
void ovsrec_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_port_update_rstp_status_setkey(const struct ovsrec_port *,  const char *, const char *);
...
void ovsrec_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_port_update_statistics_setkey(const struct ovsrec_port *,  const char *, int64_t );
...
void ovsrec_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_port_update_status_setkey(const struct ovsrec_port *,  const char *, const char *);
...
void ovsrec_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_port_update_tag_addvalue(const struct ovsrec_port *,  int64_t );
...
void ovsrec_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_port_update_trunks_addvalue(const struct ovsrec_port *,  int64_t );
...
void ovsrec_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_port_update_vlan_mode_addvalue(const struct ovsrec_port *,  const char *);
...
void ovsrec_qos_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_qos_update_other_config_setkey(const struct ovsrec_qos *,  const char *, const char *);
...
void ovsrec_qos_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_qos_update_queues_setkey(const struct ovsrec_qos *,  int64_t , const struct ovsrec_queue *);
...
void ovsrec_qos_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_qos_add_clause_type(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *type);
...
void ovsrec_queue_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_queue_update_external_ids_setkey(const struct ovsrec_queue *,  const char *, const char *);
...
void ovsrec_queue_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_queue_update_other_config_setkey(const struct ovsrec_queue *,  const char *, const char *);
...
void ovsrec_ssl_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_ssl_add_clause_ca_cert(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *ca_cert);
void ovsrec_ssl_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_ssl_add_clause_certificate(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *certificate);
void ovsrec_ssl_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_ssl_update_external_ids_setkey(const struct ovsrec_ssl *,  const char *, const char *);
...
void ovsrec_ssl_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_ssl_add_clause_private_key(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *private_key);
...
void ovsrec_sflow_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_sflow_update_external_ids_setkey(const struct ovsrec_sflow *,  const char *, const char *);
...
void ovsrec_sflow_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_sflow_update_header_addvalue(const struct ovsrec_sflow *,  int64_t );
...
void ovsrec_sflow_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_sflow_update_polling_addvalue(const struct ovsrec_sflow *,  int64_t );
...
void ovsrec_sflow_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_sflow_update_sampling_addvalue(const struct ovsrec_sflow *,  int64_t );
...
void ovsrec_sflow_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void ovsrec_sflow_update_targets_addvalue(const struct ovsrec_sflow *,  const char *);
