...
ovs_sysconfdir(void)
{
    static struct directory d = {
        NULL, "/usr/etc", "OVS_SYSCONFDIR", OVSTHREAD_ONCE_INITIALIZER
    };
...
{
    static struct directory d = {
        NULL, "/usr/var/run/openvswitch", "OVS_RUNDIR", OVSTHREAD_ONCE_INITIALIZER
    };
...
{
    static struct directory d = {
        NULL, "/usr/var/log/openvswitch", "OVS_LOGDIR", OVSTHREAD_ONCE_INITIALIZER
    };
