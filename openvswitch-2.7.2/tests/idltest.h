...
void idltest_link1_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void idltest_link1_add_clause_k(struct ovsdb_idl_condition *, enum ovsdb_function function, const struct uuid *k);
void idltest_link1_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void idltest_link1_update_ka_addvalue(const struct idltest_link1 *,  const struct idltest_link1 *);
...
void idltest_link1_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void idltest_link1_update_l2_addvalue(const struct idltest_link1 *,  const struct idltest_link2 *);
...
void idltest_link2_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void idltest_link2_update_l1_addvalue(const struct idltest_link2 *,  const struct idltest_link1 *);
...
void idltest_simple_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void idltest_simple_update_ba_addvalue(const struct idltest_simple *,  bool );
...
void idltest_simple_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void idltest_simple_add_clause_i(struct ovsdb_idl_condition *, enum ovsdb_function function, int64_t i);
void idltest_simple_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void idltest_simple_update_ia_addvalue(const struct idltest_simple *,  int64_t );
...
void idltest_simple_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void idltest_simple_add_clause_r(struct ovsdb_idl_condition *, enum ovsdb_function function, double r);
void idltest_simple_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void idltest_simple_update_ra_addvalue(const struct idltest_simple *,  double );
...
void idltest_simple_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void idltest_simple_add_clause_s(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *s);
void idltest_simple_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void idltest_simple_update_sa_addvalue(const struct idltest_simple *,  const char *);
...
void idltest_simple_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void idltest_simple_add_clause_u(struct ovsdb_idl_condition *, enum ovsdb_function function, struct uuid u);
void idltest_simple_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void idltest_simple_update_ua_addvalue(const struct idltest_simple *,  struct uuid );
...
void idltest_simple2_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void idltest_simple2_add_clause_name(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *name);
void idltest_simple2_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void idltest_simple2_update_smap_setkey(const struct idltest_simple2 *,  const char *, const char *);
...
void idltest_simple3_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void idltest_simple3_update_uref_addvalue(const struct idltest_simple3 *,  const struct idltest_simple4 *);
...
void idltest_simple3_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void idltest_simple3_update_uset_addvalue(const struct idltest_simple3 *,  struct uuid );
