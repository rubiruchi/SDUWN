...
__attribute__((section("__versions"))) = {
	...
	{ 0x5720a49b, __VMLINUX_SYMBOL_STR(ovs_gre_fill_metadata_dst) },
	{ 0x998d2b07, __VMLINUX_SYMBOL_STR(rpl_gre_fb_xmit) },
	...
	{ 0x9f1a8473, __VMLINUX_SYMBOL_STR(rpl_gretap_fb_dev_create) },
...
MODULE_INFO(srcversion, "94738550B68CD8A207212E5");
