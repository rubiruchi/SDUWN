...
__attribute__((section("__versions"))) = {
	...
	{ 0x46ac85a1, __VMLINUX_SYMBOL_STR(ovs_vxlan_fill_metadata_dst) },
	{ 0x83db9a68, __VMLINUX_SYMBOL_STR(rpl_vxlan_xmit) },
	...
	{ 0x39dfb1e4, __VMLINUX_SYMBOL_STR(rpl_vxlan_dev_create) },
...
MODULE_INFO(srcversion, "271CB33B4573AD0421A0363");
