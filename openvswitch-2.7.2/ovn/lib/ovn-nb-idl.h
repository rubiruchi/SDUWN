...
void nbrec_acl_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_acl_add_clause_direction(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *direction);
void nbrec_acl_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_acl_update_external_ids_setkey(const struct nbrec_acl *,  const char *, const char *);
...
void nbrec_acl_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_acl_add_clause_log(struct ovsdb_idl_condition *, enum ovsdb_function function, bool log);
void nbrec_acl_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_acl_add_clause_match(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *match);
void nbrec_acl_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_acl_add_clause_priority(struct ovsdb_idl_condition *, enum ovsdb_function function, int64_t priority);
...
void nbrec_address_set_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_address_set_update_external_ids_setkey(const struct nbrec_address_set *,  const char *, const char *);
...
void nbrec_address_set_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_address_set_add_clause_name(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *name);
...
void nbrec_connection_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_connection_update_inactivity_probe_addvalue(const struct nbrec_connection *,  int64_t );
...
void nbrec_connection_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_connection_add_clause_is_connected(struct ovsdb_idl_condition *, enum ovsdb_function function, bool is_connected);
void nbrec_connection_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_connection_update_max_backoff_addvalue(const struct nbrec_connection *,  int64_t );
...
void nbrec_connection_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_connection_update_other_config_setkey(const struct nbrec_connection *,  const char *, const char *);
...
void nbrec_connection_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_connection_update_status_setkey(const struct nbrec_connection *,  const char *, const char *);
...
void nbrec_connection_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_connection_add_clause_target(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *target);
...
void nbrec_dhcp_options_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_dhcp_options_update_external_ids_setkey(const struct nbrec_dhcp_options *,  const char *, const char *);
...
void nbrec_dhcp_options_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_dhcp_options_update_options_setkey(const struct nbrec_dhcp_options *,  const char *, const char *);
...
void nbrec_load_balancer_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_load_balancer_add_clause_name(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *name);
void nbrec_load_balancer_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_load_balancer_update_protocol_addvalue(const struct nbrec_load_balancer *,  const char *);
...
void nbrec_load_balancer_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_load_balancer_update_vips_setkey(const struct nbrec_load_balancer *,  const char *, const char *);
...
void nbrec_logical_router_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_router_update_external_ids_setkey(const struct nbrec_logical_router *,  const char *, const char *);
...
void nbrec_logical_router_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_router_update_load_balancer_addvalue(const struct nbrec_logical_router *,  const struct nbrec_load_balancer *);
...
void nbrec_logical_router_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_router_add_clause_name(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *name);
void nbrec_logical_router_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_router_update_nat_addvalue(const struct nbrec_logical_router *,  const struct nbrec_nat *);
...
void nbrec_logical_router_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_router_update_options_setkey(const struct nbrec_logical_router *,  const char *, const char *);
...
void nbrec_logical_router_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_router_update_ports_addvalue(const struct nbrec_logical_router *,  const struct nbrec_logical_router_port *);
...
void nbrec_logical_router_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_router_update_static_routes_addvalue(const struct nbrec_logical_router *,  const struct nbrec_logical_router_static_route *);
...
void nbrec_logical_router_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_router_port_update_external_ids_setkey(const struct nbrec_logical_router_port *,  const char *, const char *);
...
void nbrec_logical_router_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_router_port_add_clause_mac(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *mac);
void nbrec_logical_router_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_router_port_add_clause_name(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *name);
void nbrec_logical_router_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_router_port_update_networks_addvalue(const struct nbrec_logical_router_port *,  const char *);
...
void nbrec_logical_router_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_router_port_update_options_setkey(const struct nbrec_logical_router_port *,  const char *, const char *);
...
void nbrec_logical_router_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_router_port_update_peer_addvalue(const struct nbrec_logical_router_port *,  const char *);
...
void nbrec_logical_router_static_route_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_router_static_route_add_clause_nexthop(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *nexthop);
void nbrec_logical_router_static_route_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_router_static_route_update_output_port_addvalue(const struct nbrec_logical_router_static_route *,  const char *);
...
void nbrec_logical_router_static_route_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_router_static_route_update_policy_addvalue(const struct nbrec_logical_router_static_route *,  const char *);
...
void nbrec_logical_switch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_switch_update_external_ids_setkey(const struct nbrec_logical_switch *,  const char *, const char *);
...
void nbrec_logical_switch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_switch_update_load_balancer_addvalue(const struct nbrec_logical_switch *,  const struct nbrec_load_balancer *);
...
void nbrec_logical_switch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_switch_add_clause_name(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *name);
void nbrec_logical_switch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_switch_update_other_config_setkey(const struct nbrec_logical_switch *,  const char *, const char *);
...
void nbrec_logical_switch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_switch_update_ports_addvalue(const struct nbrec_logical_switch *,  const struct nbrec_logical_switch_port *);
...
void nbrec_logical_switch_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_switch_update_qos_rules_addvalue(const struct nbrec_logical_switch *,  const struct nbrec_qos *);
...
void nbrec_logical_switch_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_switch_port_update_dhcpv4_options_addvalue(const struct nbrec_logical_switch_port *,  const struct nbrec_dhcp_options *);
...
void nbrec_logical_switch_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_switch_port_update_dhcpv6_options_addvalue(const struct nbrec_logical_switch_port *,  const struct nbrec_dhcp_options *);
...
void nbrec_logical_switch_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_switch_port_update_dynamic_addresses_addvalue(const struct nbrec_logical_switch_port *,  const char *);
...
void nbrec_logical_switch_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_switch_port_update_enabled_addvalue(const struct nbrec_logical_switch_port *,  bool );
...
void nbrec_logical_switch_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_switch_port_update_external_ids_setkey(const struct nbrec_logical_switch_port *,  const char *, const char *);
...
void nbrec_logical_switch_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_switch_port_add_clause_name(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *name);
void nbrec_logical_switch_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_switch_port_update_options_setkey(const struct nbrec_logical_switch_port *,  const char *, const char *);
...
void nbrec_logical_switch_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_switch_port_update_parent_name_addvalue(const struct nbrec_logical_switch_port *,  const char *);
...
void nbrec_logical_switch_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_switch_port_update_port_security_addvalue(const struct nbrec_logical_switch_port *,  const char *);
...
void nbrec_logical_switch_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_switch_port_update_tag_addvalue(const struct nbrec_logical_switch_port *,  int64_t );
...
void nbrec_logical_switch_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_switch_port_update_tag_request_addvalue(const struct nbrec_logical_switch_port *,  int64_t );
...
void nbrec_logical_switch_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_switch_port_add_clause_type(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *type);
void nbrec_logical_switch_port_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_logical_switch_port_update_up_addvalue(const struct nbrec_logical_switch_port *,  bool );
...
void nbrec_nat_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_nat_update_external_mac_addvalue(const struct nbrec_nat *,  const char *);
...
void nbrec_nat_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_nat_add_clause_logical_ip(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *logical_ip);
void nbrec_nat_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_nat_update_logical_port_addvalue(const struct nbrec_nat *,  const char *);
...
void nbrec_nat_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_nat_add_clause_type(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *type);
...
void nbrec_nb_global_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_nb_global_update_external_ids_setkey(const struct nbrec_nb_global *,  const char *, const char *);
...
void nbrec_nb_global_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_nb_global_add_clause_hv_cfg(struct ovsdb_idl_condition *, enum ovsdb_function function, int64_t hv_cfg);
void nbrec_nb_global_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_nb_global_add_clause_nb_cfg(struct ovsdb_idl_condition *, enum ovsdb_function function, int64_t nb_cfg);
void nbrec_nb_global_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_nb_global_add_clause_sb_cfg(struct ovsdb_idl_condition *, enum ovsdb_function function, int64_t sb_cfg);
void nbrec_nb_global_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_nb_global_update_ssl_addvalue(const struct nbrec_nb_global *,  const struct nbrec_ssl *);
...
void nbrec_qos_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_qos_add_clause_direction(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *direction);
void nbrec_qos_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_qos_update_external_ids_setkey(const struct nbrec_qos *,  const char *, const char *);
...
void nbrec_qos_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_qos_add_clause_match(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *match);
void nbrec_qos_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_qos_add_clause_priority(struct ovsdb_idl_condition *, enum ovsdb_function function, int64_t priority);
...
void nbrec_ssl_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_ssl_add_clause_ca_cert(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *ca_cert);
void nbrec_ssl_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_ssl_add_clause_certificate(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *certificate);
void nbrec_ssl_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_ssl_update_external_ids_setkey(const struct nbrec_ssl *,  const char *, const char *);
...
void nbrec_ssl_set_condition(struct ovsdb_idl *, struct ovsdb_idl_condition *); void nbrec_ssl_add_clause_private_key(struct ovsdb_idl_condition *, enum ovsdb_function function, const char *private_key);
